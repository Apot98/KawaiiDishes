...
public class ContainerRegister {
    ...
    public static final RegistryObject<MenuType<DisplayCaseContainer>> DISPLAY_CASE = CONTAINERS.register("display_case", () -> IForgeMenuType.create(DisplayCaseContainer::new));
